...
class TweetCell: DatasourceCell {
  ...
  let retweetButton = UIButton(type: .system) {
    $0.setImage(#imageLiteral(resourceName: "retweet").withRenderingMode(.alwaysOriginal), for: .normal)
  }
  
  let likeButton = UIButton(type: .system) {
    $0.setImage(#imageLiteral(resourceName: "like").withRenderingMode(.alwaysOriginal), for: .normal)
  }
  
  let directMessageButton = UIButton(type: .system) {
    $0.setImage(#imageLiteral(resourceName: "send_message").withRenderingMode(.alwaysOriginal), for: .normal)
  }
